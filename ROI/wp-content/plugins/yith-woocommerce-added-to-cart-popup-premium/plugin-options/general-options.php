...
$general = array(
	...
	'general'  => array(
        ...
        array(
            'name' => __( 'Show product info', 'yith-woocommerce-added-to-cart-popup' ),
		...
		defined( 'YITH_YWRAQ_INIT' ) && YITH_YWRAQ_INIT ? array(
			'name' => __( 'Enable for "Request A Quote" button', 'yith-woocommerce-added-to-cart-popup' ),
        ...
        defined( 'YITH_WFBT_INIT' ) && YITH_WFBT_INIT ? array(
            'name' => __( 'Enable for "Frequently Bought Together" button', 'yith-woocommerce-added-to-cart-popup' ),
