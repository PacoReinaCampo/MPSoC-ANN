...
<?php
		...
		public static function __get_none_string() {
			return isset( self::$filter['none_text'] ) && !empty( self::$filter['none_text'] ) ? esc_html( self::$filter['none_text'] ) : apply_filters( 'prdctfltr_none_text', esc_html__( 'None', 'xforwoocommerce' ) );
		}

		public static function __get_none_tooltip_string() {
			return '';

			// return apply_filters( 'prdctfltr_none_tooltip', esc_html__( 'Clear filters', 'xforwoocommerce' ) );
		}
