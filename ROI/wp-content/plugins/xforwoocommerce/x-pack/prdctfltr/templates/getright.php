		...
		case 'loop/pagination.php' :
			...
			?>
				...
				<?php
					...
					?>
						<a href="#" class="button"><?php esc_html_e( 'Load More', 'xforwoocommerce' ); ?></a>
					<?php
					}
					else {
					?>
						<span class="button disabled"><?php esc_html_e( 'No More Products!', 'xforwoocommerce' ); ?></span>
					<?php
					}
				?>
				</nav>
			...
			?>
				...
				<?php
					...
					?>
						<span class="button disabled"><?php esc_html_e( 'No products found', 'xforwoocommerce' ); ?></span>
					<?php
					}
				?>
				</nav>
