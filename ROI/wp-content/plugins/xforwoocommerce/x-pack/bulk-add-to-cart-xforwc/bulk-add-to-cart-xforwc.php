...
Text Domain: bulk-add-to-cart-xforwc
*/
...
if ( !class_exists( 'XforWC_BulkAddtoCart' ) ) :

	final class XforWC_BulkAddtoCart {
		...
		public function __construct() {
			do_action( 'bulk_add_to_cart_xforwc_loading' );
			...
			do_action( 'bulk_add_to_cart_xforwc_loaded' );
		}
		...
		public function load_plugin_textdomain() {
			...
			$domain = 'bulk-add-to-cart-xforwc';
	...
	function XforWC_BulkAddtoCart() {
		return XforWC_BulkAddtoCart::instance();
	}

	XforWC_BulkAddtoCart::instance();
