...
Text Domain: live-search-xforwc
*/
...
if ( !class_exists( 'XforWC_LiveSearch' ) ) :

	final class XforWC_LiveSearch {
		...
		public function __construct() {
			do_action( 'live_search_xforwc_loading' );
			...
			do_action( 'live_search_xforwc_loaded' );
		}
	...
	function XforWC_LiveSearch() {
		return XforWC_LiveSearch::instance();
	}

	XforWC_LiveSearch::instance();
