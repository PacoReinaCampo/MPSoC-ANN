...
Text Domain: floating-cart-xforwc
*/
...
if ( !class_exists( 'XforWC_FloatingCart' ) ) :

	final class XforWC_FloatingCart {
		...
		public function __construct() {
			do_action( 'floating_cart_xforwc_loading' );
			...
			do_action( 'floating_cart_xforwc_loaded' );
		}
	...
	function XforWC_FloatingCart() {
		return XforWC_FloatingCart::instance();
	}

	XforWC_FloatingCart::instance();
