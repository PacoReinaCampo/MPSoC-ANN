		...
		public function admin_fields_draggable_position( $value ) {
			...
			<tr valign="top">
                ...
                <td class="forminp"
					...
					<input name="<?php echo esc_attr( $value['id'] ); ?>[top]" id="<?php echo esc_attr( $value['id'] ); ?>_top" type="hidden" value="<?php echo $position['top'] ?>" />
					<input name="<?php echo esc_attr( $value['id'] ); ?>[left]" id="<?php echo esc_attr( $value['id'] ); ?>_left" type="hidden" value="<?php echo $position['left'] ?>" />
					<span class="description"><?php echo $value['desc']; ?></span>
				</td>
			</tr>
				...
				jQuery(document).ready(function ($) {
					$('#<?php echo esc_attr( $value['id'] ); ?>_draggable').draggable({
                        ...
                        create: function( event, ui ) {
                            let top     = 270 * ( '<?php echo $position['top']; ?>' / 100 ),
                                left    = 320 * ( '<?php echo $position['left']; ?>' / 100 );
