...
if( ! function_exists( 'yith_wacp_get_style_options' ) ) {
	...
	function yith_wacp_get_style_options() {
		...
		$inline_css .= '#yith-wacp-popup .yith-wacp-main{background-color: ' . get_option( 'yith-wacp-popup-background' ) . ';}
			#yith-wacp-popup .yith-wacp-overlay{background-color: ' . get_option( 'yith-wacp-overlay-color' ). ';}
			#yith-wacp-popup.open .yith-wacp-overlay{opacity: ' . get_option( 'yith-wacp-overlay-opacity' ) . ';}
			#yith-wacp-popup .yith-wacp-close{color: ' . get_option( 'yith-wacp-close-color' ) . ';}
			#yith-wacp-popup .yith-wacp-close:hover{color: ' . get_option( 'yith-wacp-close-color-hover' ) . ';}
			#yith-wacp-popup .yith-wacp-message{color: ' . get_option( 'yith-wacp-message-text-color' ) . ';background-color: ' . get_option( 'yith-wacp-message-background-color' ) . ';}
			.yith-wacp-content .cart-info > div{color: ' . get_option( 'yith-wacp-cart-info-label-color' ) . ';}
			.yith-wacp-content .cart-info > div span{color: ' . get_option( 'yith-wacp-cart-info-amount-color' ) . ';}
			.yith-wacp-content table.cart-list td.item-info .item-name:hover,.yith-wacp-content h3.product-title:hover{color: ' . get_option( 'yith-wacp-product-name-color-hover' ) . ';}
			.yith-wacp-content table.cart-list td.item-info .item-name,.yith-wacp-content table.cart-list td.item-info dl,.yith-wacp-content h3.product-title{color: ' . get_option( 'yith-wacp-product-name-color' ) . ';}
			.yith-wacp-content table.cart-list td.item-info .item-price,.yith-wacp-content .product-price,.yith-wacp-content ul.products li.product .price,.yith-wacp-content ul.products li.product .price ins {color: ' . get_option( 'yith-wacp-product-price-color' ) . ';}';
...
if( ! function_exists( 'yith_wacp_get_cart_info' ) ) {
	...
	function yith_wacp_get_cart_info(){
		...
		$cart_info['discount']  = WC()->cart->get_total_discount();
